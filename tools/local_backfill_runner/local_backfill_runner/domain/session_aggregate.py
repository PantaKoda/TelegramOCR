...
from local_backfill_runner.parser.entity_identity import customer_fingerprint, location_fingerprint
from local_backfill_runner.parser.semantic_normalizer import CanonicalShift, SHIFT_TYPE_PRIORITY
