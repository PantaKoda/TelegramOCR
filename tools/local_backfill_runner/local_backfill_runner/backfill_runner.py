...
from local_backfill_runner.domain.notification_rules import build_notifications
from local_backfill_runner.domain.schedule_diff import diff_schedules
from local_backfill_runner.domain.session_aggregate import aggregate_session_shifts
from local_backfill_runner.infra.event_store import load_day_snapshot, process_observation
from local_backfill_runner.infra.notification_store import persist_notifications
from local_backfill_runner.ocr.paddle_adapter import create_paddle_ocr, run_paddle_on_image
from local_backfill_runner.parser.layout_parser import parse_layout
from local_backfill_runner.parser.semantic_normalizer import CanonicalShift, normalize_entries
from local_backfill_runner.runtime.date_resolution import extract_schedule_date_from_boxes, resolve_session_schedule_dates
...
def process_one_session(
    ...
    *,
    ...
    for image in images:
        ...
        try:
            extracted_date = extract_schedule_date_from_boxes(boxes, default_year=ocr_default_year)
    ...
    try:
        schedule_date, resolved_dates, inherited_image_count = resolve_session_schedule_dates(image_dates)
    except Exception as error:  # noqa: BLE001
